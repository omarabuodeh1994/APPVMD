...
def vmd_each_veh_pass(file_path,veh_class,case_study,pass_num,fs,low_freq,freq_res,num_peaks,bridge_len,vel):
    ...
    for sens in range(num_sensors):
        opt_mode_temp, opt_alpha_temp = get_opt_vmd_params (filt_sig_off[:,sens],[100,1000],[2,7],sig_params_opt)
        opt_mode_off.append(opt_mode_temp)
        opt_alpha_off.append(opt_alpha_temp)
        opt_mode_temp, opt_alpha_temp = get_opt_vmd_params (filt_sig_on[:,sens],[100,1000],[2,7],sig_params_opt)
...
if __name__ == '__main__':
    ...
    V = 10
    # file inputs:
    file_path = '../../parametric_study_4_veh/case_studies/Rob_thesis/'
    L = [21.3,30.,40.,21.3,21.3,21.3,21.3,21.3,21.3,20.,38.,56.,13.,28.,44.]
