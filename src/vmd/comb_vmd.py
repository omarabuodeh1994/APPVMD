    ...
    for case_idx,case_study in enumerate(case_studies):
        for veh_class in veh_classes:
            ...
            for bridge_name in bridge_names:
                ...
                # vmd_res_temp = pd.read_csv(file_path+case_study+'/'+veh_class+'/'+bridge_name+'/'+'stat_'+bridge_name+'.csv')
                # vmd_binned_temp = pd.read_csv(file_path+case_study+'/'+veh_class+'/'+bridge_name+'/'+'set_diff_'+bridge_name+'.csv')
                # vmd_dom_temp = pd.read_csv(file_path+case_study+'/'+veh_class+'/'+bridge_name+'/'+'stat_dominant_'+bridge_name+'.csv')
...
if __name__ == '__main__':
    ...
    # file inputs:
    file_path = '../../parametric_studies/parametric_study_4_veh_3/case_studies/'
    ...
    cases_to_ignore = [['Rob_CNN','Rob_thesis','fatigue'],['small_thick','med_num'],['low_num','low_num_constant_flexure'],['small_thick','med_num']]
    veh_masses = [940,1707,2450,4800]
    freq_res = 0.1
    # bridge parameters:
    L = [
    ...
    vmd_results,vmd_binned_results = read_vmd_results(file_path,case_studies,veh_classes,bridge_names,modes_included,cases_to_ignore)
    vmd_results[(vmd_results['veh_class'] == 'SUV') & (vmd_results['bridge_name'] == 'large_thick') & (vmd_results['case_study'] == 'Rob_thesis')]
    ...
    dom_freq_df[(dom_freq_df['veh_class']=='truck') & (dom_freq_df['case_study']=='Rob_CNN')]['bridge_name']
    ...
    # not detected
    count_not_detected_hb = dom_freq_df[(dom_freq_df['veh_class']=='hatchback') & (dom_freq_df['bridge_freq_detection']=='not detected')].shape[0]
    count_not_detected_sedan = dom_freq_df[(dom_freq_df['veh_class']=='sedan') & (dom_freq_df['bridge_freq_detection']=='not detected')].shape[0]
    count_not_detected_suv = dom_freq_df[(dom_freq_df['veh_class']=='SUV') & (dom_freq_df['bridge_freq_detection']=='not detected')].shape[0]
    count_not_detected_tr = dom_freq_df[(dom_freq_df['veh_class']=='truck') & (dom_freq_df['bridge_freq_detection']=='not detected')].shape[0]
    # greater than 70 % 
    count_high_hb = dom_freq_df[(dom_freq_df['veh_class']=='hatchback') & (dom_freq_df['bridge_freq_detection']=='detected') & (dom_freq_df['peak_f_prob'] >= 0.7)].shape[0]
    count_high_sedan = dom_freq_df[(dom_freq_df['veh_class']=='sedan') & (dom_freq_df['bridge_freq_detection']=='detected') & (dom_freq_df['peak_f_prob'] >= 0.7)].shape[0]
    count_high_suv = dom_freq_df[(dom_freq_df['veh_class']=='SUV') & (dom_freq_df['bridge_freq_detection']=='detected') & (dom_freq_df['peak_f_prob'] >= 0.7)].shape[0]
    ...
    # 40% - 70%: 
    count_med_hb = dom_freq_df[(dom_freq_df['veh_class']=='hatchback') & (dom_freq_df['bridge_freq_detection']=='detected') & ((dom_freq_df['peak_f_prob'] < 0.7) & (dom_freq_df['peak_f_prob'] >= 0.4))].shape[0]
    count_med_sedan = dom_freq_df[(dom_freq_df['veh_class']=='sedan') & (dom_freq_df['bridge_freq_detection']=='detected') & ((dom_freq_df['peak_f_prob'] < 0.7) & (dom_freq_df['peak_f_prob'] >= 0.4))].shape[0]
    count_med_suv = dom_freq_df[(dom_freq_df['veh_class']=='SUV') & (dom_freq_df['bridge_freq_detection']=='detected') & ((dom_freq_df['peak_f_prob'] < 0.7) & (dom_freq_df['peak_f_prob'] >= 0.4))].shape[0]
    ...
    # less than 40%
    count_low_hb = dom_freq_df[(dom_freq_df['veh_class']=='hatchback') & (dom_freq_df['bridge_freq_detection']=='detected') & (dom_freq_df['peak_f_prob'] < 0.4)].shape[0]
    count_low_sedan = dom_freq_df[(dom_freq_df['veh_class']=='sedan') & (dom_freq_df['bridge_freq_detection']=='detected') & (dom_freq_df['peak_f_prob'] < 0.4)].shape[0]
    count_low_suv = dom_freq_df[(dom_freq_df['veh_class']=='SUV') & (dom_freq_df['bridge_freq_detection']=='detected') & (dom_freq_df['peak_f_prob'] < 0.4)].shape[0]
    ...
    df_counts = pd.DataFrame({'veh_class':veh_classes,'not_detected':[count_not_detected_hb,count_not_detected_sedan,count_not_detected_suv,count_not_detected_tr],'low_count':[count_low_hb,count_low_sedan,count_low_suv,count_low_truck],
                                'med_count':[count_med_hb,count_med_sedan,count_med_suv,count_med_truck],'high_count':[count_high_hb,count_high_sedan,count_high_suv,count_high_truck]})
    ...
    with sns.plotting_context(plot_style):
        ...
        # hatchback
        fig_act_vs_pred_hb,axs_act_vs_pred_hb = plot_actual_vs_predicted(dom_freq_df,'bridge_freq_true','peak_f','veh_class','hatchback','Hz')
        mse_hb = mean_squared_error(dom_freq_df[dom_freq_df['veh_class'] == 'hatchback']['bridge_freq_true'],dom_freq_df[dom_freq_df['veh_class'] == 'hatchback']['peak_f'])
        r2_hb = r2_score(dom_freq_df[(dom_freq_df['veh_class'] == 'hatchback') & (dom_freq_df['peak_f'] > 0)]['bridge_freq_true'],dom_freq_df[(dom_freq_df['veh_class'] == 'hatchback')& (dom_freq_df['peak_f'] > 0)]['peak_f'])
        # fig_act_vs_pred_hb.savefig('./results/general/statistics/act_vs_pred_hb.pdf',bbox_inches='tight')
        # # SUV
        fig_act_vs_pred_sedan,axs_act_vs_pred_sedan = plot_actual_vs_predicted(dom_freq_df,'bridge_freq_true','peak_f','veh_class','sedan','Hz')
        mse_sedan = mean_squared_error(dom_freq_df[dom_freq_df['veh_class'] == 'sedan']['bridge_freq_true'],dom_freq_df[dom_freq_df['veh_class'] == 'sedan']['peak_f'])
        r2_sedan = r2_score(dom_freq_df[(dom_freq_df['veh_class'] == 'sedan') & (dom_freq_df['peak_f'] > 0)]['bridge_freq_true'],dom_freq_df[(dom_freq_df['veh_class'] == 'sedan')& (dom_freq_df['peak_f'] > 0)]['peak_f'])
        # fig_act_vs_pred_sedan.savefig('./results/general/statistics/act_vs_pred_sedan.pdf',bbox_inches='tight')
        # # SUV
        fig_act_vs_pred_suv,axs_act_vs_pred_suv = plot_actual_vs_predicted(dom_freq_df,'bridge_freq_true','peak_f','veh_class','SUV','Hz')
        mse_suv = mean_squared_error(dom_freq_df[dom_freq_df['veh_class'] == 'SUV']['bridge_freq_true'],dom_freq_df[dom_freq_df['veh_class'] == 'SUV']['peak_f'])
        r2_suv = r2_score(dom_freq_df[(dom_freq_df['veh_class'] == 'SUV') & (dom_freq_df['peak_f'] > 0)]['bridge_freq_true'],dom_freq_df[(dom_freq_df['veh_class'] == 'SUV')& (dom_freq_df['peak_f'] > 0)]['peak_f'])
        # fig_act_vs_pred_suv.savefig('./results/general/statistics/act_vs_pred_suv.pdf',bbox_inches='tight')
        # # truck
        fig_act_vs_pred_tr,axs_act_vs_pred_tr = plot_actual_vs_predicted(dom_freq_df,'bridge_freq_true','peak_f','veh_class','truck','Hz')
        mse_tr = mean_squared_error(dom_freq_df[dom_freq_df['veh_class'] == 'truck']['bridge_freq_true'],dom_freq_df[dom_freq_df['veh_class'] == 'truck']['peak_f'])
        ...
        # fig_act_vs_pred_tr.savefig('./results/general/statistics/act_vs_pred_tr.pdf',bbox_inches='tight')
        ...
        # g.savefig('./results/general/statistics.pdf',bbox_inches = 'tight')
        # histogram:
        # Probabilities:
        fig_hist_prob,ax_hist_prob = plt.subplots(2,2)
        hist_hb = sns.histplot(data = dom_freq_df[(dom_freq_df['veh_class']=='hatchback') & (dom_freq_df['bridge_freq_detection']=='detected')],x='peak_f_prob',bins=10,ax = ax_hist_prob[0,0])
        hist_sedan = sns.histplot(data = dom_freq_df[(dom_freq_df['veh_class']=='sedan')& (dom_freq_df['bridge_freq_detection']=='detected')],x='peak_f_prob',bins=10,ax = ax_hist_prob[0,1])
        hist_suv = sns.histplot(data = dom_freq_df[(dom_freq_df['veh_class']=='SUV')& (dom_freq_df['bridge_freq_detection']=='detected')],x='peak_f_prob',bins=10,ax = ax_hist_prob[1,0])
        hist_truck = sns.histplot(data = dom_freq_df[(dom_freq_df['veh_class']=='truck')& (dom_freq_df['bridge_freq_detection']=='detected')],x='peak_f_prob',bins=10,ax = ax_hist_prob[1,1])
        # greater than 0.7:
        fig_hist,ax_hist = plt.subplots(1,3,figsize=(24,10))
        hist_I = sns.histplot(data=high_cr_tr,x='EI',bins=range(5,65,5),ax=ax_hist[0])
        hist_I.set_xticks(range(5,65,5))
        hist_L = sns.histplot(data=high_cr_tr,x='span',bins=range(20,65,5),ax=ax_hist[1])
        hist_L.set_xticks(range(20,65,5))
        hist_L.set_yticks(range(0,6))
        hist_M = sns.histplot(data=high_cr_tr,x='mass',bins=range(4000,18000,2000),ax=ax_hist[2])
        ...
        # fig_hist.savefig('./results/general/histograms_truck/high_cr_2.pdf',bbox_inches='tight')
        # greater than 0.4-0.7:
        fig_hist,ax_hist = plt.subplots(1,3,figsize=(24,10))
        hist_I = sns.histplot(data=med_cr_tr,x='EI',bins=range(0,120,20),ax=ax_hist[0])
        hist_I.set_yticks(range(0,5))
        hist_L = sns.histplot(data=med_cr_tr,x='span',bins=range(15,50,5),ax=ax_hist[1])
        hist_L.set_yticks(range(0,5))
        hist_M = sns.histplot(data=med_cr_tr,x='mass',bins=range(4000,16000,2000),ax=ax_hist[2])
        hist_M.set_yticks(range(0,5))
        fig_hist.suptitle('Medium Confidence Region')
        ax_hist[0].set_title('Histogram of Bridge EI');ax_hist[1].set_title('Histogram of Bridge Span Lengths');ax_hist[2].set_title('Histogram of Bridge Masses')
        ax_hist[0].set_xlabel('EI ($\mathregular{GN-m^2}$)');ax_hist[1].set_xlabel('Span Length (m)');ax_hist[2].set_xlabel('Bridge Mass (kg/m)')
        # fig_hist.savefig('./results/general/histograms_truck/med_cr_2.pdf',bbox_inches='tight')
        # less than 0.4:
        fig_hist,ax_hist = plt.subplots(1,3,figsize=(24,10))
        hist_I = sns.histplot(data=low_cr_tr,x='EI',bins=range(0,120,20),ax=ax_hist[0])
        # hist_I.set_yticks(range(0,4))
        hist_L = sns.histplot(data=low_cr_tr,x='span',bins=range(10,50,5),ax=ax_hist[1])
        hist_L.set_xticks(range(10,50,5))
        ...
        ax_hist[0].set_title('Histogram of Bridge EI');ax_hist[1].set_title('Histogram of Bridge Span Lengths');ax_hist[2].set_title('Histogram of Bridge Masses')
        ax_hist[0].set_xlabel('EI ($\mathregular{GN-m^2}$)');ax_hist[1].set_xlabel('Span Length (m)');ax_hist[2].set_xlabel('Bridge Mass (kg/m)')
        # fig_hist.savefig('./results/general/histograms_truck/low_cr_2.pdf',bbox_inches='tight')
        # not detected:
        fig_hist,ax_hist = plt.subplots(1,3,figsize=(24,10))
        hist_I = sns.histplot(data=not_detected_tr,x='EI',bins=range(0,260,40),ax=ax_hist[0])
        hist_I.set_xticks(range(0,260,40))
        hist_I.set_yticks(range(0,5))
        hist_L = sns.histplot(data=not_detected_tr,x='span',bins=range(10,70,10),ax=ax_hist[1])
        hist_L.set_xticks(range(10,70,10))
        hist_M = sns.histplot(data=not_detected_tr,x='mass',bins=range(6000,20000,2000),ax=ax_hist[2])
        hist_M.set_yticks(range(0,4))
        fig_hist.suptitle('Not Detected')
        # fig_hist.savefig('low_cr.pdf')
        ax_hist[0].set_title('Histogram of Bridge EI');ax_hist[1].set_title('Histogram of Bridge Span Lengths');ax_hist[2].set_title('Histogram of Bridge Masses')
        ax_hist[0].set_xlabel('EI ($\mathregular{GN-m^2}$)');ax_hist[1].set_xlabel('Span Length (m)');ax_hist[2].set_xlabel('Bridge Mass (kg/m)')
        # fig_hist.savefig('./results/general/histograms_truck/not_detected_tr.pdf',bbox_inches='tight')
    ...
    final_stat = pd.DataFrame({'veh_class':veh_classes,'MSE':[mse_hb,mse_sedan,mse_suv,mse_tr],'r2':[r2_hb,r2_sedan,r2_suv,r2_tr]})
    print(final_stat)
    # plt.show()
    pdb.set_trace()
